...
import {View, SafeAreaView, Text, TextInput, TouchableWithoutFeedback, Image} from "react-native";
...
export default function Proposal({ navigation }) {
    ...
    return(
        <SafeAreaView style={{backgroundColor: 'white', height: '100%',}}>
            ...
            <TitleSubtitleInactive title="Proposal" subtitle="Toronto Food Bank" />

            <DisplayTextBlock title="Details" text={lorem} />
