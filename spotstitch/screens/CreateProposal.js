...
export default function CreateProposal ({ navigation }) {
    ...
    return(
        <SafeAreaView style={{backgroundColor: 'white', height: '100%'}}>
            ...
            <Text style={{color: "black", fontSize: 30, fontWeight: '700', textAlign: "center", paddingTop: 10, paddingBottom: 27}}>Create Proposal</Text>
            ...
            <TouchableWithoutFeedback onPress={() => modifyRoles()}>
                <Text style={{marginLeft: 35, color: "#1881fa", fontSize: 16, paddingTop: 2, fontWeight: "600"}}>Modify Roles</Text>
            </TouchableWithoutFeedback>
